...
from MPlexA.detectron2.config import CfgNode as CfgNode_
from MPlexA.detectron2.config import configurable
from MPlexA.detectron2.structures import Instances
from MPlexA.detectron2.structures.boxes import pairwise_iou
from MPlexA.detectron2.tracking.utils import LARGE_COST_VALUE,create_prediction_pairs
...
class VanillaHungarianBBoxIOUTracker(BaseHungarianTracker):
	...
	def from_config(cls,cfg:CfgNode_):
		...
		return{
			'_target_':'MPlexA.detectron2.tracking.vanilla_hungarian_bbox_iou_tracker.VanillaHungarianBBoxIOUTracker',# noqa
			'video_height':video_height,
			'video_width':video_width,
			'max_num_instances':max_num_instances,
			'max_lost_frame_count':max_lost_frame_count,
