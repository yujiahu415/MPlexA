...
from MPlexA.detectron2.config import CfgNode,LazyConfig,instantiate
from MPlexA.detectron2.data import DatasetCatalog
from MPlexA.detectron2.data.detection_utils import read_image
from MPlexA.detectron2.modeling import build_model
from MPlexA.detectron2.structures import Boxes,Instances,ROIMasks
		...
		def _unregister_custom_op_symbolic(symbolic_name,opset_version):
			...
			def _get_ns_op_name_from_custom_op(symbolic_name):
				try:
					...
					if not bool(
						re.match('^[a-zA-Z0-9-_]*::[a-zA-Z-_]+[a-zA-Z0-9-_]*$',symbolic_name)
					):
						raise ValueError(
