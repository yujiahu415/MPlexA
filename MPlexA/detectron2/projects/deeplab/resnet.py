...
from MPlexA.detectron2.layers import CNNBlockBase,Conv2d,get_norm
from MPlexA.detectron2.modeling import BACKBONE_REGISTRY
from MPlexA.detectron2.modeling.backbone.resnet import(
	BasicStem,
	BottleneckBlock,
