...
import MPlexA.detectron2# noqa F401
from MPlexA.detectron2.structures import Boxes,Instances
from MPlexA.detectron2.utils.env import _import_file
_counter=0
...
def patch_builtin_len(modules=()):
	...
	with ExitStack()as stack:
		MODULES=[
			'MPlexA.detectron2.modeling.roi_heads.fast_rcnn',
			'MPlexA.detectron2.modeling.roi_heads.mask_head',
			'MPlexA.detectron2.modeling.roi_heads.keypoint_head',
		]+list(modules)
...
def patch_nonscriptable_classes():
	...
	from MPlexA.detectron2.modeling.backbone import ResNet,FPN
	...
	from MPlexA.detectron2.modeling.roi_heads import StandardROIHeads
